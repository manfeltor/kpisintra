...
partido_flex_postalcodes_zonification_matrix = {
    ...
    'GARIN': {'zona': 'NORTE', 'apertura': 'ZONA_1'},
    'MALVINAS ARGENTINAS': {'zona': 'NORTE', 'apertura': 'ZONA_1'},
    'JOSE CLEMENTE PAZ': {'zona': 'NOROESTE', 'apertura': 'ZONA_1'},
    'INGENIERO MASCHWITZ': {'zona': 'NORTE', 'apertura': 'ZONA_2'},
    'DEL VISO': {'zona': 'NOROESTE', 'apertura': 'ZONA_2'},
    ...
    'NORDELTA': {'zona': 'NORTE', 'apertura': 'ZONA_3'},
    'ESCOBAR': {'zona': 'NORTE', 'apertura': 'ZONA_3'},
    'PILAR': {'zona': 'NOROESTE', 'apertura': 'ZONA_3'},
    'VILLA ROSA': {'zona': 'NOROESTE', 'apertura': 'ZONA_3'},
    'DERQUI': {'zona': 'NOROESTE', 'apertura': 'ZONA_3'},
    ...
    'BERISSO': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'CAMPANA': {'zona': 'NORTE', 'apertura': 'ZONA_4'},
    'CAÑUELAS': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'ENSENADA': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'GENERAL RODRIGUEZ': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'GUERNICA': {'zona': 'OESTE', 'apertura': 'ZONA_4'},
    'LUJAN': {'zona': 'OESTE', 'apertura': 'ZONA_4'},
    'MARCOS PAZ': {'zona': 'OESTE', 'apertura': 'ZONA_4'},
    'SAN VICENTE': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'ZARATE': {'zona': 'NORTE', 'apertura': 'ZONA_4'},
    'LA PLATA NORTE': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'LA PLATA OESTE': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'LA PLATA': {'zona': 'SUR', 'apertura': 'ZONA_4'},
    'EXALTACION DE LA CRUZ': {'zona': 'NORTE', 'apertura': 'ZONA_4'},
    'PRESIDENTE PERON': {'zona': 'SUR', 'apertura': 'ZONA_3'},
}
