...
from .views import download_entregas_interior_descriptive_stats
...
urlpatterns = [
    ...
    path('kpisentregas/entregasinterior/descriptive/download', download_entregas_interior_descriptive_stats, name='download_entregas_interior_descriptive_stats'),
    ]